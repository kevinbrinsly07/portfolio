...
const Skills = () => {
  return (
    <section id="skills" className="py-20 bg-[#010408]">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold mb-10">Technology Stack
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
          {skills.map((skill) => (
            <div
              key={skill.name}
              className=" p-6 rounded-lg shadow-md border-2 border-transparent hover:border-[#39FF14] hover:scale-105 transition duration-300 ease-in-out flex flex-col items-center"
            >
