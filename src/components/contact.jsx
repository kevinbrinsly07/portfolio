    ...
    <section id="contact" className=" bg-black py-2 text-center pb-30">
      <div className="container mx-auto px-6">
        ...
        <div className="social-media flex justify-center mt-6 space-x-4">
          <a
            href="https://web.facebook.com/kevin.paris.922"
            className=" rounded-lg hover:bg-blue-600 hover:text-white transition duration-300"
          >
            <img src={facebook} alt="Facebook" className="w-15 h-15" />
          </a>
          <a
            href="https://twitter.com/kevin_brinsly"
            className=" rounded-lg hover:bg-gray-400 hover:text-white transition duration-300"
          >
            <img src={x} alt="Twitter" className="w-15 h-15" />
          </a>
          <a
            href="https://www.instagram.com/kevinbrinsly/"
            className="rounded-lg hover:bg-pink-500 hover:text-white transition duration-300"
          >
            <img src={insta} alt="Instagram" className="w-15 h-15" />
          </a>
          <a
            href="https://www.linkedin.com/in/kevin-brinsly-se/"
            className=" rounded-lg hover:bg-blue-700 hover:text-white transition duration-300"
          >
